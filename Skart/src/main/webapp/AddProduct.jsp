...
<body>		
	<center>
		...
		<form action="ProductController?vid=<%=request.getParameter("vid")  %>" method="post">
		<br>
		...
		<input type="text" name="productCount" class="form-control" placeholder="Product Count" required><br>
