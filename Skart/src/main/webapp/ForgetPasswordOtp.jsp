...
<body>
 ...
 SkartUser userRegister =new SkartUser((String)request.getParameter("username"),(String)request.getParameter("password"),otp);
session.setAttribute("userRegister",userRegister);
 vf.emailVerification(userRegister);
%>
...
function validateForm() {
	...
	<center>			
		<form name="myForm" action="UpdatePassword.jsp" method="post"  >
		<br> 
